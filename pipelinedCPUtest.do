...
add wave -noupdate {/MY_CPU/Regfile[2]}	
...
add wave -noupdate {/MY_CPU/inputA}
add wave -noupdate {/MY_CPU/IDEXReg[A]}
add wave -noupdate {/MY_CPU/ForwardReg2[FORWARD_DATA]}
add wave -noupdate {/MY_CPU/Memory[ForwardReg2[FORWARD_DATA]]}
